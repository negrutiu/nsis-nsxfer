...
set CL=/nologo /O1 /Ob2 /Os /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL" /D "_WINDLL" /D "_UNICODE" /D "UNICODE" /GF /FD /MT /LD /GS- /Fo".\%OUTDIR%\temp\\" /Fd".\%OUTDIR%\temp\\" /Fe".\%OUTDIR%\%OUTNAME%" /W3
rc.exe /Fo ".\%OUTDIR%\temp\resource.res" "resource.rc"
set LINK=/INCREMENTAL:NO /MANIFEST:NO /MACHINE:X86 /NODEFAULTLIB kernel32.lib user32.lib wininet.lib ".\%OUTDIR%\temp\resource.res"
cl.exe "main.c" "utils.c" "queue.c" "nsiswapi\pluginapi.c" && set BUILD_SUCCESSFUL=1
